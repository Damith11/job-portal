    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span> Anuradhapura , Kekirawa</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://0778456312">077854620</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:damithbuddika6561@gmail.com">damith11@gmail.com</a></p>
          </div>
          <!-- <div class="col-md-3">
