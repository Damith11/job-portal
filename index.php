...
?>
    ...
    $result="SELECT * FROM all_jobs LEFT JOIN company ON all_jobs.customer_email=company.admin WHERE keyword 
    LIKE '%$keyword%' OR category='$category' limit $page1,5";
...
while ($row=mysqli_fetch_array($sql)) { 
 ?>
   ...
   <?php  } ?>
    ...
    <!-- <div class="col-md-12 ftco-animate">
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="ml-auto d-flex">
                <a href="blog-single.php" class="btn btn-primary py-2 mr-1">Apply Job</a>
                ...
                <div class="col text-center">
                  <div class="block-27">
                    <ul>
                      ...
                      $sql =mysqli_query($conn,"SELECT * FROM all_jobs LEFT JOIN company ON all_jobs.customer_email=company.admin WHERE keyword 
                      LIKE '%$keyword%' OR category='$category' ");
                      ...
                      <li><a href="index.php?page=<?php echo $b;?> & keyword=<?php echo $keyword;?> & category=<?php echo $category;?> "> <?php echo $b ;?>
                    </a></li>
                     <?php } ?>
                      <li><a href="#">&gt;</a></li>
                    </ul>
  ...
  <?php }?>       
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/jbbg3.jpg);" data-stellar-background-ratio="0.5">
    	<div class="container">
